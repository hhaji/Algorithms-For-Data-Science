...
4. ### <a name="L4"></a>Introduction to Data Mining  

    ```
    Required Reading:
    ```
    
    - Chapter 1 of [Mining of Massive Datasets](http://www.mmds.org)  
...
5. ### <a name="L5"></a>MapReduce and the New Software Stack

    ```
    Required Reading:
    ```
    
    - Chapter 2 of [Mining of Massive Datasets](http://www.mmds.org)  
